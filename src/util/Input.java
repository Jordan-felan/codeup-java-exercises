...
//    };
    ...
    public int getInt(){
        ...
        try {
            Integer.valueOf(getString("Enter a number!"));
    ...
    public double getDouble(){
        try {
            Double.valueOf(getString("Enter a decimal Number"));
        } catch (NumberFormatException nfe){
            System.out.println("Uh oh, " + nfe.getMessage() + " that is not a decimal number!!");
        }
        return 0;
    };
